		...
		<Card
			...
			body = {show ? (
				...
				<div className="text-left">	
						<img src="bank.png" className="img-fluid left" alt="Responsive image" width="22%"/><br/><br/>
					</div>
				Email<br/>
				...
				<button type="submit" className="btn btn-primary" onClick={attemptLogin}>Login</button><br/><br/>
				...
				<h5> {currentuser} <br/>
                You are now logged in to your account!</h5> <br/><br/>
				<h6>Make a <a href="#deposit" class="btnDeposit">Deposit.</a></h6>  <br/><br/>
				<h6>Make a <a href="#withdraw" class="btnDeposit">Withdraw.</a></h6>  <br/><br/>
				<h6>See all your <a href="#alldata" class="btnDeposit">Data.</a></h6>  <br/><br/>
